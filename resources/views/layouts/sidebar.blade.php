<nav class=" sidebar-menu" id="si-sidebar">
  <ul id="sidebar-toggle" class="si-menu">
      <li class="@yield('dashboard')">
        ...
        <li class="@yield('main-active')" >
            <a href="#main" class="collapsed" data-toggle="collapse" aria-expanded="false">
            ...
            <div id="main"  class="collapse @yield('main')">
                <ul>
                    <li class="@yield('employees') ">
                        <a href="/employees" class="collapsed" >
                    ...
                    <li class="@yield('divisions') ">
                      <a href="/divisions" class="collapsed" >
                    ...
                    <li class="@yield('items') ">
                        <a href="/items" class="collapsed" >
                  ...
                  <li class="@yield('types')">
                      <a href="/types" class="collapsed">
                          ...
                          <span class="ml-4">Type</span>
                      </a>
                  </li>
                </ul>
            </div>
        </li>
        <li class="@yield('inventories')">
            <a href="/inventories" class="collapsed">
